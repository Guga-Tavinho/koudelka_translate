...
class ImportWindow(tk.Toplevel):
    def __init__(self, master, source, selected=0):
        ...
        self.buttons = []
        for text, callback in [('Importar PNG…', self.choose_png), ('Recarregar PNG', self.reload_png),
                               ('Desfazer nesta imagem', self.reset_current), ('Salvar novo TX8…', self.save_tx8)]:
