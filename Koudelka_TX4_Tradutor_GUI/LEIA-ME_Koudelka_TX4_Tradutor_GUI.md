...
- nos blocos de itens 1–114, a descrição fica limitada à coluna esquerda
  (`X=10..169`, largura máxima de 160 px), reservando a área direita para a
  imagem do item; a quebra automática usa mais linhas em vez de sobrepor o
  sprite;
