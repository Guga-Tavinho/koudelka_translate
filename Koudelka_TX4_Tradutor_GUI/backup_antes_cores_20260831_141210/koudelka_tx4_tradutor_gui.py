...
class TX4Project:
    ...
    def original_image(self, block: int) -> Image.Image:
        return indices_to_rgb(self.block_indices(block), self.view_height, self.display_palette(block))
    ...
    def preview_image(self, entry: Entry, font: ImageFont.FreeTypeFont) -> Image.Image:
        ...
        return indices_to_rgb(indices, self.view_height, self.display_palette(entry.block))
