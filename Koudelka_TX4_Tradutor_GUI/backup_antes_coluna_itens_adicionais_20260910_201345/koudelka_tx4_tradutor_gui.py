...
# A versao anterior usava TEXT_MAX_X tambem nos blocos 1-114, portanto uma
# traducao longa podia ser desenhada por baixo do sprite. O original prefere
# mais linhas na coluna esquerda.
ITEM_TEXT_MAX_X = 170
...
class TX4Project:
    ...
    def text_width_limit(self, entry: Entry | None = None) -> int:
        ...
        if entry is not None and entry.block <= ITEM_LAST_BLOCK:
...
class TranslatorGUI:
    ...
    def _build_ui(self) -> None:
        ...
        self.rule_note = ttk.Label(
            right,
            text=(
                "Blocos 1–114 preservam o título e mantêm a descrição na coluna esquerda, "
                "sem avançar sobre a imagem do item. "
