...
Para manter uma paleta corrigida, abra o TX4 com as cores corrigidas como origem.
Gerar TX4 continua preservando essa paleta: nao a substitui automaticamente.
O arquivo original nao e sobrescrito.

Para fontes pretas, existe a opcao **Fundo claro (somente na previa)**. Ela troca
